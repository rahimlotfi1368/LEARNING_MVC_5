...
namespace MY_APPLICATION.Areas.MultiLanguage.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.MultiLanguage.Home; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "MultiLanguage";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/MultiLanguage/Views/Home/Create.cshtml";
            public readonly string Index = "~/Areas/MultiLanguage/Views/Home/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : MY_APPLICATION.Areas.MultiLanguage.Controllers.HomeController
    {
        public T4MVC_HomeController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, bool? result);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(bool? result)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "result", result);
            IndexOverride(callInfo, result);
            return callInfo;
        }
        ...
        [NonAction]
        partial void ChangeCultureOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string cultureName);

        [NonAction]
        public override System.Web.Mvc.ActionResult ChangeCulture(string cultureName)
        {
            ...
            ChangeCultureOverride(callInfo, cultureName);
            return callInfo;
        }
