...
namespace MY_APPLICATION.Areas.SimpleSecurity.Controllers
{
    public partial class HomeController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public HomeController Actions { get { return MVC.SimpleSecurity.Home; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "SimpleSecurity";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Action1 = "~/Areas/SimpleSecurity/Views/Home/Action1.cshtml";
            public readonly string Action2 = "~/Areas/SimpleSecurity/Views/Home/Action2.cshtml";
            public readonly string Action3 = "~/Areas/SimpleSecurity/Views/Home/Action3.cshtml";
            public readonly string Index = "~/Areas/SimpleSecurity/Views/Home/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_HomeController : MY_APPLICATION.Areas.SimpleSecurity.Controllers.HomeController
    {
