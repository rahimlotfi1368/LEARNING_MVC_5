...
namespace MY_APPLICATION.Areas.Area_1.Controllers
{
    public partial class UserController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public UserController Actions { get { return MVC.Area_1.User; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Area_1";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string List = "~/Areas/Area_1/Views/User/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_UserController : MY_APPLICATION.Areas.Area_1.Controllers.UserController
    {
