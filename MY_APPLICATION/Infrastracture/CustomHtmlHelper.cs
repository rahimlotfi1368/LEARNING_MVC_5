...
namespace Infrastracture
{
	public static class CustomHtmlHelper
	{
		...
		public static System.Web.IHtmlString DtxDisplayNameAndValueFor<TModel, TValue>
			(this System.Web.Mvc.HtmlHelper<TModel> html,
			System.Linq.Expressions.Expression<System.Func<TModel, TValue>> expression,
			Rlx.Enums.DisplayValueType displayValueType = Rlx.Enums.DisplayValueType.Undefined,
			int labelColumn = 3,
			string caption = null
			...
			)
		{
			...
			{
				valueString =
					Rlx.Constant.DISPLAY_NULL_VALUE;
			}
			else
			{
				switch (displayValueType)
				{
					case Rlx.Enums.DisplayValueType.Number:
					{
						valueString =
					...
					case Rlx.Enums.DisplayValueType.Percent:
					{
						valueString =
							Convert.Number(valueObject);
					...
					case Rlx.Enums.DisplayValueType.Currency:
					{
						valueString =
							Convert.Number(valueObject);
					...
					case Rlx.Enums.DisplayValueType.Date:
					{
						try
						{
					...
					case Rlx.Enums.DisplayValueType.DateTime:
					{
						try
						{
							System.DateTime dateTime =
					...
					case Rlx.Enums.DisplayValueType.Raw:
					{
						valueString =
					...
					case Rlx.Enums.DisplayValueType.Url:
					{
						valueString =
					...
					case Rlx.Enums.DisplayValueType.EmailAddress:
					{
						valueString =
