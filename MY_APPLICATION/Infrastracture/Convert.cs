namespace Infrastracture
{
	public static class Convert
	{
		...
		public static string Number(object value, string displayNullValue = Rlx.Constant.DISPLAY_NULL_VALUE)
		{
			if (value == null)
			{
		...
		public static string Number(long? value, string displayNullValue = Rlx.Constant.DISPLAY_NULL_VALUE)
		{
		...
		public static string
			DateTime(System.DateTime? value, bool displayTime = true, string displayNullValue = Rlx.Constant.DISPLAY_NULL_VALUE)
		{
			if (value.HasValue == false)
			{
				return displayNullValue;
