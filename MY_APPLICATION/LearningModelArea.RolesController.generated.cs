...
namespace MY_APPLICATION.Areas.LearningModelArea.Controllers
{
    public partial class RolesController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public RolesController Actions { get { return MVC.LearningModelArea.Roles; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "LearningModelArea";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Areas/LearningModelArea/Views/Roles/Create.cshtml";
            public readonly string Delete = "~/Areas/LearningModelArea/Views/Roles/Delete.cshtml";
            public readonly string Details = "~/Areas/LearningModelArea/Views/Roles/Details.cshtml";
            public readonly string Edit = "~/Areas/LearningModelArea/Views/Roles/Edit.cshtml";
            public readonly string Index = "~/Areas/LearningModelArea/Views/Roles/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_RolesController : MY_APPLICATION.Areas.LearningModelArea.Controllers.RolesController
    {
