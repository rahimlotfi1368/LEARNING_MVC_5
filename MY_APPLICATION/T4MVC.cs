...
{
    static readonly Area_1Class s_Area_1 = new Area_1Class();
    public static Area_1Class Area_1 { get { return s_Area_1; } }
    static readonly Area_2Class s_Area_2 = new Area_2Class();
    public static Area_2Class Area_2 { get { return s_Area_2; } }
    static readonly Area_3Class s_Area_3 = new Area_3Class();
    public static Area_3Class Area_3 { get { return s_Area_3; } }
    static readonly LearningModelAreaClass s_LearningModelArea = new LearningModelAreaClass();
    ...
    public static MY_APPLICATION.Controllers.LearningValidationController LearningValidation = new MY_APPLICATION.Controllers.T4MVC_LearningValidationController();
    public static MY_APPLICATION.Controllers.LearningViewsController LearningViews = new MY_APPLICATION.Controllers.T4MVC_LearningViewsController();
    public static MY_APPLICATION.Controllers.OtherController Other = new MY_APPLICATION.Controllers.T4MVC_OtherController();
...
{
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class Area_1Class
    {
        public readonly string Name = "Area_1";
        public MY_APPLICATION.Areas.Area_1.Controllers.UserController User = new MY_APPLICATION.Areas.Area_1.Controllers.T4MVC_UserController();
        public T4MVC.Area_1.SharedController Shared = new T4MVC.Area_1.SharedController();
    }
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class Area_2Class
    {
        public readonly string Name = "Area_2";
        public MY_APPLICATION.Areas.Area_2.Controllers.HomeController Home = new MY_APPLICATION.Areas.Area_2.Controllers.T4MVC_HomeController();
        public T4MVC.Area_2.SharedController Shared = new T4MVC.Area_2.SharedController();
    }
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class Area_3Class
    {
        public readonly string Name = "Area_3";
        public MY_APPLICATION.Areas.Area_3.Controllers.MController M = new MY_APPLICATION.Areas.Area_3.Controllers.T4MVC_MController();
        public T4MVC.Area_3.SharedController Shared = new T4MVC.Area_3.SharedController();
    }
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class LearningModelAreaClass
    {
        public readonly string Name = "LearningModelArea";
        public MY_APPLICATION.Areas.LearningModelArea.Controllers.RolesController Roles = new MY_APPLICATION.Areas.LearningModelArea.Controllers.T4MVC_RolesController();
        public MY_APPLICATION.Areas.LearningModelArea.Controllers.UsersController Users = new MY_APPLICATION.Areas.LearningModelArea.Controllers.T4MVC_UsersController();
        public T4MVC.LearningModelArea.SharedController Shared = new T4MVC.LearningModelArea.SharedController();
    }
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
...
namespace Links
{
    ...
    public static class Content {
        ...
        public static class fonts {
            ...
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class sahel {
                public const string UrlPath = "~/Content/fonts/sahel";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(UrlPath); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(UrlPath + "/" + fileName); }
                public static readonly string Sahel_Black_FD_eot = Url("Sahel-Black-FD.eot");
                public static readonly string Sahel_Black_FD_ttf = Url("Sahel-Black-FD.ttf");
                public static readonly string Sahel_Black_FD_woff = Url("Sahel-Black-FD.woff");
                public static readonly string Sahel_Bold_FD_eot = Url("Sahel-Bold-FD.eot");
                public static readonly string Sahel_Bold_FD_ttf = Url("Sahel-Bold-FD.ttf");
                public static readonly string Sahel_Bold_FD_woff = Url("Sahel-Bold-FD.woff");
                public static readonly string Sahel_FD_eot = Url("Sahel-FD.eot");
                public static readonly string Sahel_FD_ttf = Url("Sahel-FD.ttf");
                public static readonly string Sahel_FD_woff = Url("Sahel-FD.woff");
                public static readonly string sahel_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(UrlPath + "/sahel.min.css") ? Url("sahel.min.css") : Url("sahel.css");
            }
    ...
    public static partial class Bundles
    {
        public static partial class Scripts 
        {
            ...
            public static class Assets
            {
                public static readonly string axios_js = T4MVCHelpers.ProcessAssetPath("~/Scripts/axios.js"); 
                public static readonly string axios_min_js = T4MVCHelpers.ProcessAssetPath("~/Scripts/axios.min.js"); 
        ...
        public static partial class Content 
        {
            ...
            {
                public static partial class sahel 
                {
                    public static class Assets
                    {
                        public static readonly string sahel_css = T4MVCHelpers.ProcessAssetPath("~/Content/fonts/sahel/sahel.css");
                    }
                }
                public static class Assets
                {
